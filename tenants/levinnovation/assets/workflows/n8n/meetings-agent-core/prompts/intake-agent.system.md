...
- If the user provides a meeting URL but no transcript, return `status: "pending"` and explain that a meeting-joiner/transcription service must first produce a transcript.

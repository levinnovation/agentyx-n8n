...
Canonical tenant for the vertical-domain asset framework.

## Domain

- `kitchen-commerce/` — all kitchen-related commerce capabilities
...
See `kitchen-commerce/capabilities/` for full asset listings.

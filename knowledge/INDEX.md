...
> **Auto-generated.** Run `make knowledge-index` (or `python3 scripts/knowledge_index.py`) to refresh.
...
- [agent-context/AGENTS_TEMPLATE.md](agent-context/AGENTS_TEMPLATE.md)
- [agent-context/CLAUDE_TEMPLATE.md](agent-context/CLAUDE_TEMPLATE.md)
- [agent-context/COPILOT_INSTRUCTIONS_TEMPLATE.md](agent-context/COPILOT_INSTRUCTIONS_TEMPLATE.md)
- [agent-context/CURSOR_RULES_TEMPLATE.md](agent-context/CURSOR_RULES_TEMPLATE.md)
- [agent-context/OPEN_CODEX_TEMPLATE.md](agent-context/OPEN_CODEX_TEMPLATE.md)
- [agent-context/OPENCODE_TEMPLATE.md](agent-context/OPENCODE_TEMPLATE.md)
- [agent-context/README.md](agent-context/README.md)

### `architecture-evolution/`

- [architecture-evolution/0001-from-agent-centric-to-domain-centric.md](architecture-evolution/0001-from-agent-centric-to-domain-centric.md)
- [architecture-evolution/0002-from-runtime-artifacts-to-business-assets.md](architecture-evolution/0002-from-runtime-artifacts-to-business-assets.md)
- [architecture-evolution/0003-from-ad-hoc-prompts-to-versioned-knowledge.md](architecture-evolution/0003-from-ad-hoc-prompts-to-versioned-knowledge.md)
- [architecture-evolution/0004-from-ephemeral-agent-context-to-repo-native-agent-memory.md](architecture-evolution/0004-from-ephemeral-agent-context-to-repo-native-agent-memory.md)
...
- [change-log/2026-05-08-composio-triggers-mcp-bridge.md](change-log/2026-05-08-composio-triggers-mcp-bridge.md)
...
- [change-log/2026-05-13-tenant-email-template-method-a-b-and-ui-hardening.md](change-log/2026-05-13-tenant-email-template-method-a-b-and-ui-hardening.md)
  - [change-log/2026-05-18-personal-assistant-core-mcp-hardening.md](change-log/2026-05-18-personal-assistant-core-mcp-hardening.md)
...
- [context-packs/agent-session-bootstrap.md](context-packs/agent-session-bootstrap.md)
- [context-packs/claude-code-session-bootstrap.md](context-packs/claude-code-session-bootstrap.md)
...
- [context-packs/repo-context.md](context-packs/repo-context.md)

### `decisions/`

- [decisions/0001-vertical-domain-centric-architecture.md](decisions/0001-vertical-domain-centric-architecture.md)
- [decisions/0002-tenants-own-business-capabilities.md](decisions/0002-tenants-own-business-capabilities.md)
- [decisions/0003-technology-assets-are-subordinate-to-domain-capabilities.md](decisions/0003-technology-assets-are-subordinate-to-domain-capabilities.md)
...
- [glossary/ai-agent-dev-tools.md](glossary/ai-agent-dev-tools.md)
- [glossary/domain-terms.md](glossary/domain-terms.md)
- [glossary/README.md](glossary/README.md)
- [glossary/technical-terms.md](glossary/technical-terms.md)
- [glossary/vendor-terms.md](glossary/vendor-terms.md)

### `lessons/`

- [lessons/0001-do-not-let-runtime-tools-become-the-architecture.md](lessons/0001-do-not-let-runtime-tools-become-the-architecture.md)
- [lessons/0002-version-prompts-as-first-class-assets.md](lessons/0002-version-prompts-as-first-class-assets.md)
- [lessons/0003-avoid-vendor-ui-as-source-of-truth.md](lessons/0003-avoid-vendor-ui-as-source-of-truth.md)
- [lessons/0004-agent-context-must-be-versioned-not-retyped.md](lessons/0004-agent-context-must-be-versioned-not-retyped.md)
...
- [operations/multichannel-chat-runbook.md](operations/multichannel-chat-runbook.md)
- [operations/n8n-mcp-bridge-runbook.md](operations/n8n-mcp-bridge-runbook.md)
...
- [operations/portal-signup-and-approval-runbook.md](operations/portal-signup-and-approval-runbook.md)
...
- [prompts/claude-code/README.md](prompts/claude-code/README.md)
- [prompts/codewords/README.md](prompts/codewords/README.md)
- [prompts/cursor/0001-create-vertical-domain-repo.md](prompts/cursor/0001-create-vertical-domain-repo.md)
...
- [tenants/euromobilia/capability-decisions.md](tenants/euromobilia/capability-decisions.md)

...
exports.AgentyxCRMQuery = void 0;
const n8n_workflow_1 = require("n8n-workflow");
class AgentyxCRMQuery {
    description = {
        ...
        description: "Read-only queries against Twenty CRM: search people, companies, opportunities by email, name, or ID",
        defaults: {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            try {
                ...
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Twenty CRM query failed: ${msg}`, { itemIndex: i });
            }
        }
        return [returnData];
    }
}
exports.AgentyxCRMQuery = AgentyxCRMQuery;

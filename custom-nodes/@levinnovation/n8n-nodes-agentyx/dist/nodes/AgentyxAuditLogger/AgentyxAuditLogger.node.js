...
exports.AgentyxAuditLogger = void 0;
class AgentyxAuditLogger {
    description = {
        ...
        description: "Record execution metadata to agentyx_audit schema with full provenance",
        defaults: {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            const subWorkflowsRaw = this.getNodeParameter("subWorkflows", i);
            const gitHash = this.getNodeParameter("gitHash", i);
            const storeMode = this.getNodeParameter("storeMode", i);
            let subWorkflows = [];
            try {
...
exports.AgentyxAuditLogger = AgentyxAuditLogger;

...
exports.AgentyxChannelFormattedOutputNode = void 0;
...
class AgentyxChannelFormattedOutputNode {
    description = {
        ...
        description: "Format and send replies to Kapso WhatsApp, Telegram, Slack, or email with channel-specific formatting rules",
        defaults: {
        ...
        properties: [
            ...
            },
            {
                ...
                type: "string",
                typeOptions: { rows: 5 },
                default: "={{ $json.reply_text }}",
                description: "The text to send. Supports n8n expressions.",
            },
            {
                displayName: "Recipient ID",
                name: "recipientId",
                type: "string",
                default: "={{ $json.user_id }}",
                description: "Phone number (WA), chat_id (Telegram), etc.",
            },
            {
            ...
            },
            {
                ...
                default: "api",
                description: "payload = return the formatted payload for downstream HTTP node. api = send directly.",
            },
            {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            const attachmentsRaw = this.getNodeParameter("replyAttachments", i);
            const sendMethod = this.getNodeParameter("sendMethod", i);
            ...
            switch (channel) {
                ...
                case "telegram": {
                    ...
                    const disablePreview = this.getNodeParameter("disablePreview", i);
...
exports.AgentyxChannelFormattedOutputNode = AgentyxChannelFormattedOutputNode;
